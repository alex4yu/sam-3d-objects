...
# optional vertex colors: inspect and extract RGB if present
vcols = None
...
# export
tri.export("splat_from_meshextract.obj")   # OBJ
tri.export("splat_from_meshextract.ply")   # PLY
tri.export("splat_from_meshextract.glb")   # GLB (binary glTF)
